...
const
  ...
  Shifts = [42, 54, 100,102,103,104,105, 106,107,108,109,110, 29,56,97, 125];
  BufKillers = [ 15, 29, 56, 97 ];

  // 15 - 'TAB' 29 -'LEFTCTRL' 42 - 'LEFTSHIFT' 56 - 'LEFTALT' 97-'RIGHTCTRL' 125 - 'LEFTMETA'
  // 100-RIGHTALT 102-HOME    103-UP     104-PAGEUP   105-LEFT
  // 106-RIGHT    107-END     108-DOWN   109-PAGEDOWN 110-INSERT
  // 272, 273, 274 - mouse > 256
